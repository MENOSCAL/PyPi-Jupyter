...
from distributionsVM import Gaussian
from distributionsVM import Binomial

class TestGaussianClass(unittest.TestCase):
    def setUp(self):
        self.gaussian = Gaussian(25, 2)
        self.gaussian.read_data_file('C:\\Users\\ALFON\\Udacity AWS Machine Learning\\Datos\\numbers.txt')
...
class TestBinomialClass(unittest.TestCase):
    def setUp(self):
        ...
        self.binomial.read_data_file('C:\\Users\\ALFON\\Udacity AWS Machine Learning\\Datos\\numbers_binomial.txt')
